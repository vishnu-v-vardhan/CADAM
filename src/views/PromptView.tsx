...
export function PromptView() {
  ...
  const [parametricLlmProvider, setParametricLlmProvider] =
    useState<ParametricLlmProvider>('openrouter');
  ...
  const handleTypeChange = (newType: 'parametric' | 'creative') => {
    ...
    if (newType === 'creative') {
      ...
      setParametricLlmProvider('openrouter');
    }
  };
